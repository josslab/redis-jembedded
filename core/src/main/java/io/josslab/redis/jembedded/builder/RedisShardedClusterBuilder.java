...
import io.josslab.redis.jembedded.RedisShardedCluster;
import io.josslab.redis.jembedded.model.Shard;
...
public final class RedisShardedClusterBuilder {
  ...
  private PortProvider shardPortProvider = newSequencePortProvider(NetUtils.allocatePort(0));
