...
import io.josslab.redis.jembedded.model.ReplicationGroup;
...
public final class RedisClusterBuilder {
  ...
  private PortProvider replicationGroupPortProvider = newSequencePortProvider(NetUtils.allocatePort(0));
